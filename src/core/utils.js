...
if (typeof module === 'undefined') {
  ...
  window.normalizarEspacos = normalizarEspacos;
  window.normalizarSiglas = normalizarSiglas;
  window.validarCampo = validarCampo;
  window.validarCampos = validarCampos;
  window.mesclarPorAlias = mesclarPorAlias;
  window.canonicalizarCampo = canonicalizarCampo;
...
/** Emite eventos do sistema de cálculo */
window.emitCalc = function emitCalc(type, detail = {}) {
  try { window.CalcBus.dispatchEvent(new CustomEvent(type, { detail })); } catch {}
};
